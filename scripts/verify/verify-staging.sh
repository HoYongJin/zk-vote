...
#   [AUTHED_PATH=/api/me] \
#   bash scripts/verify/verify-staging.sh
#
...
EVIDENCE_PATH="${VERIFY_EVIDENCE_PATH:-${PROJECT_ROOT}/docs/evidence/verify-staging-${RUN_ID}.json}"
EVIDENCE_TMP="$(mktemp)"
...
const doc = {
  ...
  command: "bash scripts/verify/verify-staging.sh",
